...
function SillaEspecial () {
  ...
  <h3>¿Qué son las sillas ergonómicas especiales?</h3>
  <p>
  ...
  <ul className='ul1'>
    ...
    <li className='lista1'><strong>Balones ergonómicos:</strong> obligan al cuerpo a mantener el equilibrio, fomentando una postura activa y mayor movilidad durante el trabajo.</li>
    <li className='lista1'><strong>Sillas sin respaldo:</strong> diseñadas para mantener la conciencia postural en sesiones cortas; reducen la dependencia del apoyo lumbar.</li>

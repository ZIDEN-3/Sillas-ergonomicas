...
function SillaEconómica () {
  ...
  <h3>¿Qué esperar de una silla ergonómica económica?</h3>
  <p>
...
<article className='caracteristicas'>
  ...
  <ul className='ul1'>
    ...
    <li className='lista1'><strong>Diseño ergonómico básico:</strong> con forma curva para la espalda.</li>
...
<article className='caracteristicas'>
  ...
  <h3>¿Qué tener en cuenta al elegir una silla económica?</h3>
  <p>
    Aunque el precio es un factor clave, no hay que dejar de lado el respaldo que ofrece, el tipo de asiento y la garantía del producto. Una silla económica puede ser una gran inversión si elegís bien.
  </p>
